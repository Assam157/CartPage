...
const BuyPage = () => {
  ...
  console.log(username)
    ...
    const apiUrl = ` https://shoppingpage.in/api/razorpay/create-order?username=${encodeURIComponent(username)}`;
    ...
    const options = {
        ...
        handler: async function (response) {
            ...
            await fetch('https://shoppingpage.in/api/razorpay/verify', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(response)
            });

            const stockUpdateResponse = await fetch('https://shoppingpage.in/update_stock', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
            ...
            const emailUrl = ` https://shoppingpage.in/send_email?username=${username}&emailPayload=${encodedEmailPayload}`;
